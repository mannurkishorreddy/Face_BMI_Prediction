...
model = tf.keras.models.load_model('bmi_mode_2005_1.h5')
...
def main():
    ...
    if option == "Upload File":
        ...
        while True:
            ...
            video_placeholder.image(frame, channels='BGR', caption='Bounding Boxes and Predicted BMI', use_column_width=True)
